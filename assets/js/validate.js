$( document ).ready(function() {
	...
	$().ready(function() {
		...
		var container = $('div.msj');
		var validator = $("#formRegUser").validate({
			errorContainer: container,
			errorLabelContainer: $("ol", container),
			wrapper: 'li'
		});

		$('#btn_sub_reg').on('click',function(){
      		$('#alert2').fadeIn('slow');
   		});

		var container = $('div.msj2');
		...
		$('#btnlogin').on('click',function(){
   		...
   		var container = $('div.msj3');
		var validator = $("#formcpr").validate({
			errorContainer: container,
			errorLabelContainer: $("ol", container),
			wrapper: 'li'
		});
