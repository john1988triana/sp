<section class="container" style="margin-top:120px">
	<h1 class="text-center asi-funciona">Profesores Particulares de ESTADISTICA</h1>
	<div class="col-md-12 div-area">

	

	<div class="col-md-6">
		<img class="img-area" style="margin-top:20px;margin-bottom:50px;"src="<?php echo base_url("assets/img/estadistica.jpg");?>">
		<div style="padding-left:40px">
			<p>Necesitas <b style="color:#00B85C;">Clases Particulares de Estadística?.</b><br>
	...
	<div class="col-md-6">
	<iframe src="<?php echo base_url("buscador?area=30")?>" style="width:100%;height:700px;border:none;"></iframe>	
	</div>	
...
<h2 class="text-center letra-profes">ALGUNOS DE NUESTROS SUPERPROFES DE ESTADISTICA</h2>
	<div class="container">
		<div class="col-md-12">
			<div class="col-md-4">
			...
			<div class="col-md-4">
				<div class="panel-default panel-perfil">                                            
					<h3 class="text-center" style="color:#009966;">Carolina Suárez</h3>
					<div class="panel-body text-center">
