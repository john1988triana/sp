<section class="container" style="margin-top:120px">
	<h1 class="text-center asi-funciona">Profesores Particulares de CALCULO</h1>
	<div class="col-md-12 div-area">

	

	<div class="col-md-6">
		<img class="img-area" style="margin-top:20px;margin-bottom:50px;"src="<?php echo base_url("assets/img/calculo.jpg");?>">
		<div style="padding-left:40px">
			<p>Necesitas <b style="color:#00B85C;">Clases Particulares de Cálculo?.</b><br>
	...
	<div class="col-md-6">
	<iframe src="<?php echo base_url("buscador?area=34")?>" style="width:100%;height:700px;border:none;"></iframe>	
	</div>	
...
<h2 class="text-center letra-profes">ALGUNOS DE NUESTROS SUPERPROFES DE CALCULO</h2>
	<div class="container">
		<div class="col-md-12">
			<div class="col-md-4">
