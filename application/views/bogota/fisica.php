<section class="container" style="margin-top:120px">
	<h1 class="text-center asi-funciona">Profesores Particulares de fisica</h1>
	<div class="col-md-12 div-area">

	

	<div class="col-md-6">
		<img class="img-area" style="margin-top:20px;margin-bottom:50px;"src="<?php echo base_url("assets/img/fisica.jpg");?>">
		<div style="padding-left:40px">
			<p>Necesitas <b style="color:#00B85C;">Clases Particulares de Física.</b><br>
	...
	<div class="col-md-6">
	<iframe src="<?php echo base_url("buscador?area=12")?>" style="width:100%;height:700px;border:none;"></iframe>
	</div>
...
<h2 class="text-center letra-profes">ALGUNOS DE NUESTROS SUPERPROFES DE FISICA</h2>
	<div class="container">
		<div class="col-md-12">
			<div class="col-md-4">
				<div class="panel-default panel-perfil">                                            
				<h3 class="text-center" style="color:#009966;">Miller E. Hernández</h3>
					<div class="panel-body text-center">
						...
						<h4 class="par">Licenciado en Física</h4>    
						<h4 class="par">Fisica</h4>
			...
			<div class="col-md-4">
				<div class="panel-default panel-perfil">                                            
					<h3 class="text-center" style="color:#009966;">Stev Rodríguez</h3>
					<div class="panel-body text-center">
						<img class="img-profile" style="margin: 0px auto;" src="<?php echo base_url("assets/img/profesor-stev-fisica.png");?>">
						<div class="estrellas">
							<span class="glyphicon glyphicon-star" style="color: #ffcc00;"></span>
							<span class="glyphicon glyphicon-star" style="color: #ffcc00;"></span> 
							<span class="glyphicon glyphicon-star" style="color: #ffcc00;"></span> 
						...
						<h4 class="par">Bogotá</h4>  
						<h4 class="par">Estudiante Ingeniería</h4>     
						<h4 class="par">Fisica</h4>
